...
namespace Problems.Test.Design
{
    public class LRUCacheTest
    {
        ...
        public void TestLRUCacheLong()
        {
            ...
            Assert.Equal<int>(13, cache.Get(13));
            
            cache.Put(2, 19);
            
            Assert.Equal<int>(2, cache.Get(2));
            
            Assert.Equal<int>(3, cache.Get(3));

            cache.Put(5, 25);

            Assert.Equal<int>(8, cache.Get(8));
            ...
            Assert.Equal<int>(11, cache.Get(11));

            cache.Put(9, 12);
            
            Assert.Equal<int>(7, cache.Get(7));
            
            Assert.Equal<int>(5, cache.Get(5));
            
            Assert.Equal<int>(8, cache.Get(8));
            
            Assert.Equal<int>(9, cache.Get(9));
            ...
            Assert.Equal<int>(10, cache.Get(10));
            ...
            Assert.Equal<int>(12, cache.Get(12));
            ...
            Assert.Equal<int>(6, cache.Get(6));
