...
namespace Google.ArraysStrings
{
    public class StringProblems
    {
        public string MinWindow(string s, string t) 
        {
            ...
            // we have a starting search range.
            var left = 0;
            var right = 0;
            var minSize = 0;
            var minLeft = 0;
            ...
            // iterate while the left position has not proceeded beyond the right size
            // and make sure  that the right side stays less than the maximum size of the input.
